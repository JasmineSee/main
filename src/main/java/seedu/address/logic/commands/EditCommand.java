...
public class EditCommand extends UndoableCommand {
    ...
    public CommandResult executeUndoableCommand() throws CommandException {
        ...
        if (editPersonDescriptor.isEmailFieldEdited()) {
            ...
            saveNewEmailPhoto(oldEmail, newEmail);
        }
    ...
    /**
     * Saves image file of person to new email if image of person exists.
     */
    private void saveNewEmailPhoto(String oldEmail, String newEmail) {
