...
Changes colour theme of the address book. There are 3 colours available: +
...
.   Click on File
.   Select the respective colour theme (e.g. for white theme, click on the "White Theme" option).
