...
editing details of a contact, uploading photo to a contact and generating a QR code to scan the chosen contact's number on the phone for easy saving of the contact's number on the phone.
